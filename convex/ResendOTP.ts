  ...
  async sendVerificationRequest({ identifier: email, provider, token }) {
    ...
    const { error } = await resend.emails.send({
      ...
      html: `
        ...
        <body style="margin: 0; padding: 0; font-family: 'Outfit', -apple-system, BlinkMacSystemFont, 'Segoe UI', system-ui, sans-serif; background: #090909; min-height: 100vh; display: flex; align-items: center; justify-content: center;">
            ...
            <div style="background: #0a0a0a; border: 1px solid #27272a; border-radius: 0.5rem; padding: 2rem; box-shadow: 0 10px 15px -3px rgba(0, 0, 0, 0.1), 0 4px 6px -2px rgba(0, 0, 0, 0.05);">
              ...
              <div style="text-align: center; margin: 2rem 0;">
                ...
                <div style="background: rgba(16, 185, 129, 0.1); border: 1px solid #10b981; border-radius: 0.5rem; padding: 1.5rem; margin: 1rem auto; display: inline-block;">
                  <div style="color: #ffffff; font-size: 2rem; font-weight: 700; letter-spacing: 0.5rem; font-family: 'Monaco', 'Menlo', 'Ubuntu Mono', monospace;">
                    ${token}
                  </div>
                </div>
              </div>
